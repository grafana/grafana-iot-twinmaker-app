...
func NewTwinMakerInstance(ctx context.Context, s backend.DataSourceInstanceSettings) (instancemgmt.Instance, error) {
	...
	return NewTwinMakerDatasource(settings, ctx), nil
}
...
func NewTwinMakerDatasource(settings models.TwinMakerDataSourceSetting, ctx context.Context, ) *TwinMakerDatasource {
	c, err := twinmaker.NewTwinMakerClient(settings, ctx)
	if err != nil {
