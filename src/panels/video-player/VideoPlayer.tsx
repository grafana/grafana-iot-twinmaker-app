...
export const VideoPlayer = (props: VideoPlayerPropsFromParent) => {
  ...
  // TODO: use props.timeRange or props.data.timeRange ???
  ...
  useEffect(() => {
    ...
    displayOptions.entityId,
    displayOptions.componentName,
    displayOptions.kvsStreamName,
    displayOptions.startTime,
    displayOptions.endTime,
